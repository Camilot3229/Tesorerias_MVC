...
public class Indice extends javax.swing.JFrame {
    ...
    private void Centro_CostoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Centro_CostoActionPerformed
        ...
        Indice admin = new Indice();
        admin.defecto_Cc(evt, admin);
    ...
    private void Movemientos_tesoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Movemientos_tesoriaActionPerformed
        // TODO add your handling code here:
        Indice admin = new Indice();
        admin.defecto_Mt(evt, admin);
    }//GEN-LAST:event_Movemientos_tesoriaActionPerformed
    public javax.swing.JButton Cc;// Centro_Costo
    public javax.swing.JButton Mp;// Maestro_Proveedor
    public javax.swing.JButton Mt;// Movemientos_tesoria
    public javax.swing.JButton C;// comprobante
    ...
    public void defecto_Cc(java.awt.event.ActionEvent evt, Indice admin) {
        Cc = this.Centro_Costo;
    }

    public void defecto_Mp(java.awt.event.ActionEvent evt, Indice admin) {
        Mp = this.Maestro_Proveedor;
    }

    public void defecto_Mt(java.awt.event.ActionEvent evt, Indice admin) {
        Mt = this.Movemientos_tesoria;
    }

    public void defecto_C(java.awt.event.ActionEvent evt, Indice admin) {
        C = this.comprobante;
    }
